...
export const homePageBanner2 = {
  banners: [
    {
      backgroundBannerImage: "/images/HomeBannerSlider1.png",
    ...
    {
      backgroundBannerImage: "/images/HomeBannerSlider2.png",
      heading: "New Collection2",
      description:
        "2Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ",
      actionBtn1: "Shop Now",
      actionBtn2: "Explore",
    },
  ],
...
export const quotesData = {
  ...
  testimonialCards: [
    {
      id: 1,
      description: `"I've always believed that age is just a number, and with the Ageless Radiance Serum from [Your Beauty Brand], I've found the secret to aging gracefully."`,
      name: "Nishita",
      designation: "CEO, Bea-You",
    },
    {
      id: 2,
      description: `"I am absolutely in love with the Radiant Glow Daily Cleanser from Bea You       "`,
      name: "Ritesh Newal",
  ...
  data: [
    {
      ...
      image: "/images/OfferImage1.jpg",
    },
    {
      id: 2,
      title: "Mahogany Collection",
      discount: "Flat 20% Off",
      image: "/images/OfferImage2.jpg",
    },
  ],
}
...
export const footerData = {
  ...
  copyright2: {
    ...
    links: [
      {
        id: 1,
        title: "Created by Caffeine Code",
        url: "/team",
      },
    ],
  },
