...
const EditAddress: React.FC<EditAddressProps> = ({
  ...
  return (
    <>
      <div
        className={clsx(
          "border rounded-rounded p-5 min-h-[220px] h-full w-full flex justify-between gap-4 transition-colors",
          {
      ...
      >
        ...
        <div className="flex gap-x-6 pt-2">
          <Button variant="icon" className="text-green h-max" onClick={open}>
            <Edit className="w-5" />
          </Button>
          <Button
            variant="icon"
